...
DISTDIR = /home/jean/c++/2526-4imi-projetscpp-jean_arthus/.tmp/Projet1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
compiler_moc_header_make_all: moc_window.cpp moc_render_area.cpp
...
moc_render_area.cpp: src/render_area.hpp \
		src/map.hpp \
		src/ivec2.hpp \
		src/Case.hpp \
		src/Mapsolver.hpp \
...
Case.o: src/Case.cpp src/Case.hpp \
		src/ivec2.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Case.o src/Case.cpp
